set_property PACKAGE_PIN Y9 [get_ports {CLOCK_50}]
#NET CLOCK_100	LOC = Y9   | IOSTANDARD=LVCMOS33;  # "GCLK"
...
set_property PACKAGE_PIN AB22 [get_ports {VGA_G[6]}]
#NET VGA_G1        LOC = AB22 | IOSTANDARD=LVCMOS33;  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {VGA_G[7]}]
#NET VGA_G2        LOC = AA22 | IOSTANDARD=LVCMOS33;  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {VGA_G[8]}]
#NET VGA_G3        LOC = AB21 | IOSTANDARD=LVCMOS33;  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {VGA_G[9]}]
...
set_property PACKAGE_PIN V20 [get_ports {VGA_R[6]}]
#NET VGA_R1        LOC = V20  | IOSTANDARD=LVCMOS33;  # "VGA-R1"
set_property PACKAGE_PIN U20 [get_ports {VGA_R[7]}]
#NET VGA_R2        LOC = U20  | IOSTANDARD=LVCMOS33;  # "VGA-R2"
set_property PACKAGE_PIN V19 [get_ports {VGA_R[8]}]
